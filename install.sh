...
function_verify() {
    ...
    [[ $(echo $permited | grep "${IP}") = "" ]] || {
        ...
        [[ -e /usr/bin/downBase ]] || echo 'https://raw.githubusercontent.com/DanssBot/prueba/main/lista' >/usr/bin/downBase && chmod 777 /usr/bin/downBase
...
DOWS() {
    wget -O /root/lista https://raw.githubusercontent.com/DanssBot/prueba/main/lista
...
atualiza_fun() {
    ...
    wget -q -O /usr/bin/gerar https://raw.githubusercontent.com/DanssBot/prueba/main/gerador.sh && chmod +rwx /usr/bin/gerar
    cd $HOME
    msg -bar
