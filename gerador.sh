...
bot_menu() {
    ...
    [[ ! -e "${CIDdir}/confbot.sh" ]] && wget --no-check-certificate -O ${CIDdir}/confbot.sh https://raw.githubusercontent.com/DanssBot/prueba/main/intBOT.sh &>/dev/null && chmod +rwx ${CIDdir}/confbot.sh
